...
const DocsSidebar = ({
  ...
  return (
    <>
      ...
      >
        <div className="flex-1 flex flex-col bg-[#0a0a0a] rounded-3xl shadow-xl overflow-hidden border-2 border-[#22c55e] shadow-[0_0_30px_rgba(34,197,94,0.9),0_0_60px_rgba(34,197,94,0.7),0_0_90px_rgba(34,197,94,0.5),0_0_120px_rgba(34,197,94,0.3),0_0_150px_rgba(34,197,94,0.2)] animate-pulse-glow">
